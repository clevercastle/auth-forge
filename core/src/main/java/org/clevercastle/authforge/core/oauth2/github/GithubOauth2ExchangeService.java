package org.clevercastle.authforge.core.oauth2.github;
...
import org.clevercastle.authforge.core.oauth2.AbstractOauth2ExchangeService;
...
public class GithubOauth2ExchangeService extends AbstractOauth2ExchangeService {
    ...
    protected Oauth2User parse(Oauth2ClientConfig clientConfig, TokenResponse tokenResponse) throws CastleException {
        ...
        if (tokenResponse instanceof AccessTokenResponse) {
            ...
            org.clevercastle.authforge.core.http.HttpRequest httpRequest = new org.clevercastle.authforge.core.http.HttpRequest();
